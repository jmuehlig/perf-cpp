...
public:
    ...
    [[nodiscard]] std::vector<std::string> required_counter_names() const override { return {"cycles", "instructions"}; }
...
public:
    ...
    [[nodiscard]] std::vector<std::string> required_counter_names() const override { return {"cache-misses", "cache-references"}; }
    [[nodiscard]] std::optional<double> calculate(const CounterResult& result) const override
    {
...
public:
    ...
    [[nodiscard]] std::vector<std::string> required_counter_names() const override { return {"dTLB-loads", "dTLB-load-misses"}; }
    [[nodiscard]] std::optional<double> calculate(const CounterResult& result) const override
    {
...
public:
    ...
    [[nodiscard]] std::vector<std::string> required_counter_names() const override { return {"iTLB-loads", "iTLB-load-misses"}; }
    [[nodiscard]] std::optional<double> calculate(const CounterResult& result) const override
    {
...
public:
    ...
    [[nodiscard]] std::vector<std::string> required_counter_names() const override { return {"L1-dcache-loads", "L1-dcache-load-misses"}; }
    [[nodiscard]] std::optional<double> calculate(const CounterResult& result) const override
    {
