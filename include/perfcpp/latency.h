...
public:
  ...
  Latency(const std::uint32_t cache_latency, const std::uint16_t instruction_retirement_latency) noexcept
   ...
   */
  [[nodiscard]] std::uint32_t instruction_retirement_latency() const noexcept
  {
   ...
   */
  [[nodiscard]] std::uint32_t cache_latency() const noexcept { return _cache_latency; }
