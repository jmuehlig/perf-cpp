 ...
 * memory instruction.
 *
 * DEPRECATED: The weight structure will be removed from v0.12. Use InstructionExecution::Latency and DataAccess::Latency instead.
 */
class Weight
{
public:
  ...
  [[deprecated("Will be removed in v0.12. Use InstructionExecution::Latency or DataAccess::Latency instead.")]] [[nodiscard]] std::
    uint32_t
  ...
  [[deprecated("Will be removed in v0.12. Use InstructionExecution::Latency or DataAccess::Latency instead.")]] [[nodiscard]] std::uint32_t var1() const noexcept { return _var1; }
  [[deprecated("Will be removed in v0.12. Use InstructionExecution::Latency or DataAccess::Latency instead.")]] [[nodiscard]] std::uint32_t var2() const noexcept { return _var2; }
  [[deprecated("Will be removed in v0.12. Use InstructionExecution::Latency or DataAccess::Latency instead.")]] [[nodiscard]] std::uint32_t var3() const noexcept { return _var3; }
