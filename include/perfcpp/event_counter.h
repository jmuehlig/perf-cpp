...
public:
  ...
  explicit EventCounter(Config config = {}) : EventCounter(CounterDefinition::DEFAULT, config) { }
...
{
public:
  explicit MultiThreadEventCounter(std::uint16_t num_threads, Config config = {}) : MultiThreadEventCounter(CounterDefinition::DEFAULT, num_threads, config) { }
...
{
public:
  explicit MultiProcessEventCounter(std::vector<pid_t>&& process_ids, Config config = {}) : MultiProcessEventCounter(CounterDefinition::DEFAULT, std::move(process_ids), config) { }
...
{
public:
  explicit MultiCoreEventCounter(std::vector<std::uint16_t>&& cpu_ids,
                                 Config config = {}) : MultiCoreEventCounter(CounterDefinition::DEFAULT, std::move(cpu_ids), config) { }
