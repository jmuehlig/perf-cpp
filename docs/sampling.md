...
| **Is Instruction Pointer Exact** | Indicates whether the recorded instruction pointer exactly corresponds to the sampled instruction.                                | `sampler.values().instruction_pointer(true)`                                                                                             | `record.instruction_execution().is_instruction_pointer_exact()` | `bool`                                                                |
...
| **Is Due to Memory Conflict**         | Indicates whether the abort was caused by a memory conflict.                | `sampler.values().hardware_transaction_abort(true)` | `record.instruction_execution().hardware_transaction_abort()->is_due_to_memory_conflict()`         | `bool`          |
| **Is Due to Write Capacity Conflict** | Indicates whether the abort was caused by a write capacity conflict.        | `sampler.values().hardware_transaction_abort(true)` | `record.instruction_execution().hardware_transaction_abort()->is_due_to_write_capacity_conflict()` | `bool`          |
| **Is Due to Read Capacity Conflict**  | Indicates whether the abort was caused by a read capacity conflict.         | `sampler.values().hardware_transaction_abort(true)` | `record.instruction_execution().hardware_transaction_abort()->is_due_to_read_capacity_conflict()`  | `bool`          |
